...
public class Calculadora extends JFrame {
    ...
    private void calcularResultado() {
        ...
        }else if (operacion.equals("X!")){ //factorial
            resultado = calcularFactorial(Integer.parseInt(pantalla.getText()));
        }else if (operacion.equals("log10")){ //factorial
            resultado = Math.log10(Double.parseDouble(pantalla.getText()));
        }else if (operacion.equals("round")){ //factorial
